...
class Commentator:
    ...
    def describe_round(self, move1, move2, score1, score2):
        ...
        print(f'{self._fighter1} vs {self._fighter2}: {self._lp1} to {self._lp2}\n')
    ...
    def game_over(self, f1_lifepoints, f2_lifepoints):
        ...
        if f1_lifepoints > f2_lifepoints:
            print(f'THE WINNER IS {self._fighter1}')

        elif f2_lifepoints > f1_lifepoints:
            print(f'THE WINNER IS {self._fighter2}')
    ...
    def _describe_move(fighter_name, move, score, counter_move):
        print(f'{fighter_name}'
              f'{Commentator._describe_attacks(move, counter_move, score)}'
              f'{Commentator._describe_defences(move)}'
              f'{Commentator._describe_comment(move)}')
